...
app.get('/api/getBills', async (req, res, next) => {
  ...
  const API_KEY = process.env.CONGRESS_KEY;
  const { billType } = req.query; // Use req.query to get query parameters // Use req.query to get query parameters
...
app.post('/api/register', async (req, res, next) =>
{
  ...
  const newUser = {FirstName: firstName, LastName: lastName, Login: username, Email: email, Password: password, Address: address, Verified: false, ZipCode: zipCode, Interests: defaultInterests, Interests: defaultInterests};
  var error = '';
